...
export default function DesktopSidebar() {
    ...
    return (
        <div
            className="hidden md:!block min-w-[200px] max-w-[200px] h-screen overflow-hidden w-full bg-primary/5 dark:bg-secondary/30 dark:text-foreground text-muted-foreground border-r-2 border-separate"
        >
